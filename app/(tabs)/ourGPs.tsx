import { Image, ScrollView, StyleSheet, Text, View } from "react-native"; // 1. Added Image here
...
<View style={styles.header}>
  <Image source={require("../../assets/images/logo.png")} style={styles.logo} />
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.subtitle}>Meet our team of eight dedicated general practitioners. {"\n\n"}Once you have chosen a GP in mind, please navigate to our home page to make an appointment.</Text>
